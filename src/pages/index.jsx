...
import logoCohub from '@/images/logos/cohub.svg'
import logoTinyhood from '@/images/logos/tinyhood.svg'
import logoSagewell from '@/images/logos/sagewell.svg'
...
function Resume() {
  ...
  return (
    <div className="p-6 border rounded-2xl border-zinc-100 dark:border-zinc-700/40">
      ...
      <Button
        href="https://drive.google.com/uc?export=download&id=1sYldwfBJZRYSFUMPhmc3qjRS6kb43K9M"
        variant="secondary"
...
export default function Home({ posts }) {
  return (
    <>
      <Head>
        <title>Jack Spiva - Nashville based software engineer</title>
        <meta
          name="description"
          content="I'm Jack Spiva, a Nashville based software engineer mainly focused on Ruby on Rails. I'm interested in lots of things, especially music, video games, reading, and being outside."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Nashville based software engineer mainly focused on Ruby on Rails.
            Interested in lots of things, especially music, video games,
            reading, and being outside.
          </p>
          <div className="flex gap-6 mt-6">
            <SocialLink
              href="https://twitter.com/jack_spiva"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://github.com/jackspiva"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/johnspiva/"
