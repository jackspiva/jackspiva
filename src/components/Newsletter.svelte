		...
		{#if isNewsletterOpen}
			<p class="my-1 text-gray-800 dark:text-gray-200">
				Get emails from me about <span class="font-bold"
					>Lorem ipsum dolor sit, amet adipisicing elit. Libero, ducimus.</span
				>.
			</p>

			<form
				action="https://buttondown.email/api/emails/embed-subscribe/jackspiva"
				method="post"
				target="popupwindow"
				class="embeddable-buttondown-form relative my-4"
			>
				<input
					type="email"
