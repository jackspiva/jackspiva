	...
	<div class="flex flex-col-reverse items-start sm:flex-row">
		<div class="flex flex-col pr-8">
			...
			<h2 class="mb-4 text-gray-700 dark:text-gray-200">
				A place for recording some stuff I've learned.
			</h2>
...
<!--
	<section class="mb-16 w-full">
		...
		<div class="flex flex-col gap-6 md:flex-row">
			<FeatureCard title="Welcome to my personal site 2022!" href="/test-post" stringData="Jan 2022" />
			<FeatureCard
				title="Moving to a GitHub CMS"
				href="/test-post"
				stringData="Jan 2022"
			/>
			<FeatureCard title="HTML Ipsum demo" href="/test-post" stringData="Jan 2022" />
		</div>
		<a
